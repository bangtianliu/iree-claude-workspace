...
| Alias | Path | Notes |
|-------|------|-------|
| iree | /path/to/iree | Main IREE repository |
| llvm-project | /path/to/llvm-project | LLVM/MLIR monorepo |
| workspace | /home/mdawkins/claude-sandbox/iree-claude-workspace | This meta-workspace |
